...
os.chdir("C:/Users/muson/OneDrive/Documents/School/Stats Honors/Thesis/Code/Python/socceraction/socceraction")

import spadl.config as spadlconfig

M : int = 12 # number of cells
N: int = 16 # number of cells
