...
gt_direc = main_direc + "/test"
matches_direc = main_direc + "/test/matches_formatted"
...
for matchNo,filename in enumerate(os.listdir(gt_direc)):
    ...
    data.to_csv(matches_direc + '/' + str(matchNo) + '-'+left_team_name+'-'+left_team_score +'-'+right_team_name+'-'+right_team_score + '.csv',index=False)
